...
get_temp_color() {
  ...
  declare -A temp_colors=(
    [85]="#e82d62" # Dark Red for 85 and above
    [80]="#f38ba8" # Light Red for 80 to 84
    [70]="#fab387" # Orange for 70 to 79
    [60]="#f9e2af" # Yellow for 60 to 69
    [45]=""        # No color for 45 to 59
    [35]="#94e2d5" # Sky Blue for 35 to 44
    [25]="#89dceb" # Royal Blue for 25 to 34
    [15]="#74c7ec" # Blue for 15 to 24
    [0]="#89b4fa"  # Dark Blue for below 15
  )
