...
# unset ZSH_PROMPT # Uncomment to unset/disable loading of prompts from HyDE and let you load your own prompts
# ZSH_COMPINIT_CHECK=1 # Set 24 (hours) per compinit security check // lessens startup time
# ZSH_OMZ_DEFER=1 # Set to 1 to defer loading of oh-my-zsh plugins ONLY if prompt is already loaded
